...
export default function PlacesPage() {
    ...
    const perksList = [
        ...
        {perks: 'Private enterance',
        icon:   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
                </svg>
      },
    ];
        // ['Wifi', 'Free parking spot', 'TV', 'Pets', 'Private enterance']
            ...
            {action === 'new' && (
                <div>
                    <form className="">
                        ...
                        <p className="text-gray-500 text-sm">Title for your place, it must be catchy as in advertisement </p>
                        <input type="text" placeholder="title, ex: my lovely apt"/>
                        <h2 className="text-xl mt-4">Address</h2>
                        <p className="text-gray-500 text-sm">Address to this place</p>
                        <input type="text" placeholder="address" />
                        <h2 className="text-xl mt-4">Photos</h2>
                        <p className="text-gray-500 text-sm">Best pictures</p>
                        ...
                        <textarea placeholder="this place is very great"></textarea>
